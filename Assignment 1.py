...
Values : 'hello',-87.8,6
Expressions :*,-,/2. What is the difference between string and variable?

String : A string is a sequence of characters enclosed in a single('') or double(" ") quotes.

Variable : A variable is a label for storing values and accessing when needed.3. Describe three different data types.
...
An expression evaluates the task given.5. This assignment statements, like spam = 10. What is the difference between an expression and a statement?
...
print()
if condition:
for value in variable:6. After running the following code, what does the variable bacon contain?
bacon = 22
bacon + 1


237. What should the values of the following two terms be?
'spam' + 'spamspam'
'spam' * 3
